...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            login_background_image=self.env['ir.config_parameter'].sudo().get_param('rocket_digital_sv.login_background_image'),
        )
        return res
    ...
    def set_values(self):
        ...
        param.set_param('rocket_digital_sv.login_background_image', set_login_background_image)
